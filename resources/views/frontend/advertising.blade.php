    ...
    <section>
        <div class="container">
            <div class="advertising">
                <div class="left-part">
                    <img src="img/online-ads-icon.webp" alt="">
                </div>
                <div class="right-part">
                    <div class="adv-heading">Advertising <br> Contact us</div>
                    <div class="name">Dil Gurung</div>
                    <div class="contact">9841371932</div>
                    <div class="contact">alvinmediapvt@gmail.com</div>
                </div>
            </div>
        </div>
    </section>
